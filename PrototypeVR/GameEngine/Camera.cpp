...
///Credit to Will Mayers for this Function.
...
{
	this->camType = CameraType::ORTHOGRAPHIC_TYPE;
...
void Camera::setProjMatrix(const Matrix &inProjMatrix)
{
	this->projMatrix= inProjMatrix;
};
void Camera::setViewMatrix(const Matrix &inViewMatrix)
{
